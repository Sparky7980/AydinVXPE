...
if shared.VapeExecuted then
	local VERSION = "RENDER "..(getgenv().RenderIntents and getgenv().RenderIntents.Premium and " PREMIUM V3" or "V3")
	...
	local rendersafecall: ((...any) -> (), string?, ...any) -> (table?) = function(func, name, ...)
		local args: table = {...};
		task.spawn(function()
			local success: boolean, response: any = pcall(func, unpack(args));
			if RenderIntents and RenderIntents.DebugSession and name and not success then 
				GuiLibrary:notify({
					title = name,
					text = `Callback Exception: {response}`,
					icon = 'assets/WarningNotification.png',
					duration = 10,
	...
	searchbaricon.Image = downloadVapeAsset("rendervape/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = downloadVapeAsset("rendervape/assets/WindowBlur.png")
	...
	searchbaricon2.Image = downloadVapeAsset("rendervape/assets/LegitModeIcon.png")
	...
	LegitModulesExitButton.Image = downloadVapeAsset("rendervape/assets/ExitIcon1.png")
	...
	LegitModulesFrameShadow.Image = downloadVapeAsset("rendervape/assets/WindowBlur.png")
	...
	LegitModulesFrameIcon.Image = downloadVapeAsset("rendervape/assets/ProfilesIcon.png")
	...
	hoverboxshadow.Image = downloadVapeAsset("rendervape/assets/WindowBlur.png")
	...
	GuiLibrary.SaveSettings = function()
		...
		writefile(baseDirectory.."configuration/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", httpService:JSONEncode(GuiLibrary.Profiles))
		local WindowTable = {}
		...
		writefile(baseDirectory.."configuration/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", httpService:JSONEncode(GuiLibrary.Settings))
		writefile(baseDirectory.."configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt", httpService:JSONEncode(WindowTable))
	end

	GuiLibrary.LoadSettings = function(customprofile)
		if isfile("rendervape/configuration/GUIPositions.vapeprofile.txt") and (getgenv().bedwars and '6872274481' or game.PlaceId) == 2619619496 then
			writefile("rendervape/configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt", readfile("rendervape/configuration/GUIPositions.vapeprofile.txt"))
			if delfile then delfile("rendervape/configuration/GUIPositions.vapeprofile.txt") end
		end
		if shared.VapePrivate then
			if isfile("vapeprivate/configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt") == false and isfile("rendervape/configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt") then
				writefile("vapeprivate/configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt", readfile("rendervape/configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt"))
			end
			if isfile("vapeprivate/configuration/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and isfile("rendervape/configuration/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
				writefile("vapeprivate/configuration/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("rendervape/configuration/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
			end
		end
		local success2, result2 = pcall(function()
			return httpService:JSONDecode(readfile(baseDirectory.."configuration/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
		end)
		...
		if shared.VapePrivate then
			if isfile("vapeprivate/configuration/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") == false and isfile("rendervape/configuration/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") then
				writefile("vapeprivate/configuration/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", readfile("rendervape/configuration/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
			end
		end
		local success3, result3 = pcall(function()
			return httpService:JSONDecode(readfile(baseDirectory.."configuration/"..((getgenv().bedwars and '6872274481' or game.PlaceId)).."GUIPositions.vapeprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return httpService:JSONDecode(readfile(baseDirectory.."configuration/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
		end)
	...
	GuiLibrary["SwitchProfile"] = function(profilename)
		...
		if (not isfile(baseDirectory.."configuration/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt")) then
		...
		if not oldindependent then
			...
			loadfile('rendervape/core/boot.lua')()
		end
	end
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowshadow.Image = downloadVapeAsset("rendervape/assets/WindowBlur.png")
		...
		windowlogo1.Image = downloadVapeAsset("rendervape/assets/VapeLogo1.png")
		...
		windowlogo2.Image = downloadVapeAsset("rendervape/assets/VapeLogo2.png")
		...
		settingswheel.Image = downloadVapeAsset("rendervape/assets/SettingsWheel1.png")
		...
		discordbutton.Image = downloadVapeAsset("rendervape/assets/DiscordIcon.png")
		...
		settingsexit.Image = downloadVapeAsset("rendervape/assets/ExitIcon1.png")
		...
		overlaysicon.Image = downloadVapeAsset("rendervape/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = downloadVapeAsset("rendervape/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = downloadVapeAsset("rendervape/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = downloadVapeAsset("rendervape/assets/BackIcon.png")
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			buttonapi["ToggleButton"] = function(toggle, first)
				...
				rendersafecall(argstable.Function, argstable.Name, buttonapi.Enabled);
			end
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = downloadVapeAsset("rendervape/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = downloadVapeAsset("rendervape/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = downloadVapeAsset("rendervape/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = downloadVapeAsset("rendervape/assets/SliderButton1.png")
					...
					--	val = math.clamp(val, argstable["Min"], argstable["Max"])
						...
						rendersafecall(argstable.Function, argstable.Name, val);
					end
				...
				windowapi3["CreateButton2"] = function(argstable)
					...
					toggleframe1.MouseButton1Click:Connect(function() rendersafecall(argstable.Function, argstable.Name) end)
					toggleframe1.MouseEnter:Connect(function()
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = downloadVapeAsset("rendervape/assets/KeybindIcon.png")
			...
			bindtext2.Image = downloadVapeAsset("rendervape/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function()
				bindimg.Image = downloadVapeAsset("rendervape/assets/PencilIcon.png")
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = downloadVapeAsset("rendervape/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = downloadVapeAsset("rendervape/assets/ColorSlider1.png")
			...
			sliderexpand.Image = downloadVapeAsset("rendervape/assets/HoverArrow3.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("rendervape/assets/HoverArrow4.png")
			end)
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.96
				val = val or 0.52
				slider3.Image = ((sliderapi["RainbowValue"] or sliderapi["Custom"]) and downloadVapeAsset("rendervape/assets/ColorSlider2.png") or downloadVapeAsset("rendervape/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and downloadVapeAsset("rendervape/assets/RainbowIcon2.png") or downloadVapeAsset("rendervape/assets/RainbowIcon1.png"))
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = downloadVapeAsset("rendervape/assets/PinButton.png")
		...
		optionsbutton.Image = downloadVapeAsset("rendervape/assets/MoreButton3.png")
		...
		windowapi["CreateSlider"] = function(argstable)
			...
			--	val = math.clamp(val, argstable["Min"], argstable["Max"])
				...
				slider2.Size = UDim2.new(math.clamp((val / argstable["Max"]), 0.02, 0.97), 0, 1, 0)
				text2.Text = sliderapi["Value"] .. ".0 "..(argstable["Percent"] and "%" or " ").." "
				rendersafecall(argstable.Function, nil, val);
			end
			slider3.MouseButton1Down:Connect(function()
				local x,y,xscale,yscale,xscale2 = RelativeXY(slider1, inputService:GetMouseLocation())
				sliderapi["SetValue"](math.floor(argstable["Min"] + ((argstable["Max"] - argstable["Min"]) * xscale)))
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = downloadVapeAsset("rendervape/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = downloadVapeAsset("rendervape/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = downloadVapeAsset((argstable["Name"] == "ProfilesList" and "rendervape/assets/TextBoxBKG2.png" or "rendervape/assets/TextBoxBKG.png"))
				...
				textGuiLibrary["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textGuiLibrary["ObjectList"]) do
						...
						deletebutton.Image = downloadVapeAsset("rendervape/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = downloadVapeAsset("rendervape/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = downloadVapeAsset("rendervape/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
			...
			dropGuiLibrary["UpdateList"] = function(val)
				...
				if not table.find(list, dropGuiLibrary["Value"]) then
					...
					dropframe.Visible = false
					rendersafecall(argstable.Function, argstable.Name, list[1]);
				end
				...
				for numbe, listobj in pairs(val) do
					...
					drop2.MouseButton1Click:Connect(function()
						...
						dropframe.Visible = false
						--children.CanvasSize = UDim2.new(0, 0, 0, uilistlayout2.AbsoluteContentSize.Y + (dropframe.Visible and #dropframe:GetChildren() * 12 or 0) + 10)
						rendersafecall(argstable.Function, argstable.Name, listobj);
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = downloadVapeAsset("rendervape/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = downloadVapeAsset("rendervape/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = downloadVapeAsset("rendervape/assets/MoreButton2.png")
				...
				rendersafecall(argstablemain.Function, argstablemain.Name, buttonapi.Enabled);
				GuiLibrary["UpdateHudEvent"]:Fire()
			end

			function buttonapi:retoggle()
				if self.Enabled then
					rendersafecall(argstablemain.Function, argstablemain.Name);
					rendersafecall(argstablemain.Function, argstablemain.Name, true);
				end;
			end;
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = downloadVapeAsset("rendervape/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = downloadVapeAsset("rendervape/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "rendervape/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
				...
				dropGuiLibrary["UpdateList"] = function(val)
					...
					for numbe, listobj in pairs(val) do
						...
						drop2.MouseButton1Click:Connect(function()
							...
							--children.CanvasSize = UDim2.new(0, 0, 0, num)
							--windowtitle.Size = UDim2.new(0, 220, 0, math.clamp(45 + num, 0, 605))
							rendersafecall(argstable.Function, argstable.Name, listobj[1]);
							dropGuiLibrary["UpdateList"](list)
							GuiLibrary["UpdateHudEvent"]:Fire()
						end)
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderapi["SetValue"] = function(hue, sat, val)
					...
					sliderapi["Value"] = val
					slider3.Position = UDim2.new(math.clamp(hue, 0.02, 0.95), -9, 0, -7)
					rendersafecall(argstable.Function, nil, hue, sat, val);
				end
				sliderapi["SetRainbow"] = function(val)
					sliderapi["RainbowValue"] = val
					if sliderapi["RainbowValue"] then
			...
			buttonapi["CreateSlider"] = function(argstable)
				...
				sliderapi["Value"] = (argstable["Default"] or argstable["Min"])
				sliderapi["Default"] = (argstable["Default"] or argstable["Min"])
				sliderapi["Min"] = argstable["Min"] or 0;
				sliderapi["Max"] = argstable["Max"] or 1;
				sliderapi["SetValue"] = function(val)
				--	val = math.clamp(val, argstable["Min"], argstable["Max"])
					pcall(function()
						sliderapi["Value"] = val
						slider2.Size = UDim2.new(math.clamp((val / (argstable["Max"] or argstable["Min"] or 0)), 0.02, 0.97), 0, 1, 0)
						local doublecheck = argstable["Double"] and sliderapi["Value"] and argstable["Double"] and (sliderapi["Value"] / argstable["Double"]) or sliderapi["Value"] or 1;
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = downloadVapeAsset("rendervape/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = downloadVapeAsset("rendervape/assets/SliderArrow1.png")
	...
	GuiLibrary["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = downloadVapeAsset("rendervape/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, textService:GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = downloadVapeAsset("rendervape/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("rendervape/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = downloadVapeAsset("rendervape/assets/HoverArrow.png")
			end)
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sliderapi["Value"] = val
				slider3.Position = UDim2.new(math.clamp(hue, 0.02, 0.95), -9, 0, -7)
				rendersafecall(argstable.Function, argstable.Name, hue, sat, val);
			end
			sliderapi["SetRainbow"] = function(val)
				sliderapi["RainbowValue"] = val
				if sliderapi["RainbowValue"] then
	...
	function GuiLibrary:notify(args: vapenotification): {instance: Frame}
		local instance: Frame = self.CreateNotification(args.title, args.text, args.duration or 7, args.icon);
		if args.color then 
			instance.IconLabel.ImageColor3 = args.color;
			instance.Frame.Frame.ImageColor3 = args.color;
		end;
		return setmetatable({}, {__index = {instance = instance}});
	end;
	...
	GuiLibrary.objects = GuiLibrary.ObjectsThatCanBeSaved;
	return GuiLibrary
end
